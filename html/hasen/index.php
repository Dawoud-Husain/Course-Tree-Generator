...
<body>
<?php  
    $name = "MADNESS AND BADNESS COMBINATION PURRRRRRRR Hi, I am Hasen, nice to meet you! 100👋";
    ...
    $desc = "Select a Director (or all) to See Their Best Films HEY HEY COMMENTING FROM HERE SLEEPY";
    $spacing = "<br>"
